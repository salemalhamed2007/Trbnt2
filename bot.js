...
client.on('ready', function(){
    ...
    var ms = 100000 ;
    var setGame = [`Prefix-> - , By IISLooMz_`];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.youtube.com/gg`);
    }, ms);100000
...
client.on('message' , message => {
 ...
 .setURL('https://discordapp.com/api/oauth2/authorize?client_id=488651882001072129&permissions=8&scope=bot')
  message.channel.sendEmbed(embed);
   }
});
client.on('message' , message => {
...
client.login('NDg4NjUxODgyMDAxMDcyMTI5.Dn1_Fw.l8it9WHjCvZ0rQ2GGm-S1soFJyU');
